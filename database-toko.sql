...
CREATE TABLE `barang` (
  ...
  CONSTRAINT `barang_ibfk_1` FOREIGN KEY (`supplier_id`) REFERENCES `supplier` (`supplierId`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `barang_ibfk_2` FOREIGN KEY (`satuan_id`) REFERENCES `satuan` (`satuanId`)
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cabang` (
  `cabangId` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `satuan` VALUES (1,'pcs'),(2,'ML'),(3,'CM'),(5,'KUBIK');
...
-- Dump completed on 2023-01-31 10:39:03
